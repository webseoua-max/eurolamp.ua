...
<div class="my-account-header page-title 
	...
	<?php endif; ?>
	<div class="page-title-inner container	<?php echo ' text-' . get_theme_mod( 'my_account_title_align', 'left' ); ?>">
		<?php if ( !is_front_page() ) { echo do_shortcode( '[wbcr_snippet id="2668"]' ); }  ?>	
	<div class="flex-col account <?php if ( get_theme_mod( 'logo_position' ) == 'center' ) { echo 'text-center'; } else { echo 'medium-text-center'; } ?>">
