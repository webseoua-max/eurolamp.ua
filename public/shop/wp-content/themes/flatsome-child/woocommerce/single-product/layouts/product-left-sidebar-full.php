 ...
 <div class="row content-row row-large">
	...
	<div class="col large-9">
	  <?php if ( !is_front_page() ) { echo do_shortcode( '[wbcr_snippet id="2668"]' ); }  ?>
		<div class="row">
			<div class="large-<?php echo flatsome_option('product_image_width'); ?> col single__img">
				<?php
				/**
			...
			<div class="product-info summary entry-summary col col-fit <?php flatsome_product_summary_classes();?>">
				...
				?>
				<div class="garanty" data-template="product-left-sidebar-full.php">
	        <?php  echo do_shortcode('[block id="sidebar-product"]'); ?>
				</div>
			</div>
