...
if ( $related_products ) : ?>
	...
	<div class="related related-products-wrapper product__slider product-section">
		...
		if ( $heading ) :
			?>
			<p class="product-section-title container-width product-section-title-related pt-half pb-half">
