...
class Y4YM_Get_Unit_Offer_Variable extends Y4YM_Get_Unit_Offer {
	...
	use Y4YM_T_Variable_Get_Begindate;
	...
	use Y4YM_T_Variable_Get_Enddate;
	use Y4YM_T_Variable_Get_Expiry;
	use Y4YM_T_Variable_Get_Group_Id;
	use Y4YM_T_Variable_Get_Id;
	use Y4YM_T_Variable_Get_Isavailabletoindividuals;
	use Y4YM_T_Variable_Get_Isvisibletostatecustomers;
	...
	use Y4YM_T_Variable_Get_Ppcategory;
	...
	use Y4YM_T_Variable_Get_Region;
