<?php
	...
	if( !class_exists('Wbcr_FactoryForms480_FontControl') ) {

		class Wbcr_FactoryForms480_FontControl extends Wbcr_FactoryForms480_ComplexControl {
			...
			public function __construct($options, $form, $provider = null)
			{
				...
				$this->size = new Wbcr_FactoryForms480_IntegerControl($option_font_size, $form, $provider);
				$this->family = new Wbcr_FactoryForms480_DropdownControl($option_font_family, $form, $provider);
				$this->color = new Wbcr_FactoryForms480_ColorControl($optionFontColor, $form, $provider);
			...
			public function getFonts()
			{
				...
				$fonts = apply_filters('wbcr_factory_forms_480_fonts', $fonts);
				$fonts = apply_filters('wbcr_factory_forms_480_fonts-' . $this->options['name'], $fonts);
			...
			public function getDefaultFonts()
			{
				...
				$fonts = array(
					...
					array(
						'group',
						__('Sans Serif:', 'wbcr_factory_forms_480'),
						array(
					...
					array(
						'group',
						__('Serif:', 'wbcr_factory_forms_480'),
						array(
							array(
					...
					array(
						'group',
						__('Monospaced:', 'wbcr_factory_forms_480'),
						array(
