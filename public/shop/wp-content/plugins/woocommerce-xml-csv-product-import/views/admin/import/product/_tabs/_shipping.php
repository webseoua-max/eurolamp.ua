<div class="panel woocommerce_options_panel" id="shipping_product_data" style="display:none;">
    ...
    <div class="woo-add-on-free-edition-notice upgrade_template">
        ...
        <?php else: ?>
        <a href="https://www.wpallimport.com/checkout/?edd_action=add_to_cart&download_id=5839961&discount=welcome-upgrade-169&edd_options%5Bprice_id%5D=1" target="_blank" class="upgrade_woo_link"><?php _e('Upgrade to the WooCommerce Import Package to Import to Variable, Affiliate, and Grouped Products', PMWI_Plugin::TEXT_DOMAIN);?></a>
        <?php endif; ?>
