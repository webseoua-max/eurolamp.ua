...
if ( version_compare( WC_VERSION, '3.3.1', '>=' ) ) {
    ...
    abstract class WCCS_Background_Process extends WC_Background_Process {}
} else {
    ...
    /**
     * WCCS_Background_Process class.
     */
    abstract class WCCS_Background_Process extends WP_Background_Process {
