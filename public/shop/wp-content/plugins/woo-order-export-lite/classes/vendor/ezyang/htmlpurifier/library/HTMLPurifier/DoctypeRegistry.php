...
class WOE_HTMLPurifier_DoctypeRegistry
{
     ...
     * @return WOE_HTMLPurifier_Doctype Editable registered doctype
     */
    public function register(
        ...
        if (!is_object($doctype)) {
            $doctype = new WOE_HTMLPurifier_Doctype(
                $doctype,
                $xml,
                $modules,
                $tidy_modules,
     ...
     * @return WOE_HTMLPurifier_Doctype Editable doctype object
     */
    public function get($doctype)
    {
        ...
        if (!isset($this->doctypes[$doctype])) {
            ...
            $anon = new WOE_HTMLPurifier_Doctype($doctype);
            return $anon;
        }
     ...
     * @return WOE_HTMLPurifier_Doctype
     */
