...
class WOE_HTMLPurifier_DefinitionCache_Serializer extends WOE_HTMLPurifier_DefinitionCache
{
    ...
    /**
     * @param WOE_HTMLPurifier_Config $config
     * @return bool|WOE_HTMLPurifier_Config
     */
    ...
    public function generateBaseDirectoryPath($config)
    {
        ...
        $base = is_null($base) ? HTMLPURIFIER_PREFIX . '/WOE_HTMLPurifier/DefinitionCache/Serializer' : $base;
        return $base;
    }
