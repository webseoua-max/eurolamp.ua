...
class WOE_HTMLPurifier_Strategy_FixNesting extends WOE_HTMLPurifier_Strategy
{
    ...
    public function execute($tokens, $config, $context)
    {
        ...
        // refer to substrings
        $top_node = WOE_HTMLPurifier_Arborize::arborize($tokens, $config, $context);
        ...
        while (!empty($stack)) {
            ...
            while (isset($node->children[$ix])) {
                ...
                if ($child instanceof WOE_HTMLPurifier_Node_Element) {
                    $go = true;
        ...
        return WOE_HTMLPurifier_Arborize::flatten($node, $config, $context);
    }
}
