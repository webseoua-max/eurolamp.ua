 ...
 */
class WOE_HTMLPurifier_HTMLDefinition extends WOE_HTMLPurifier_Definition
{

    // FULLY-PUBLIC VARIABLES ---------------------------------------------

    /**
     * Associative array of element names to WOE_HTMLPurifier_ElementDef.
     * @type WOE_HTMLPurifier_ElementDef[]
     */
    public $info = array();
    ...
    /**
     * Associative array of deprecated tag name to WOE_HTMLPurifier_TagTransform.
     * @type array
     */
    public $info_tag_transform = array();

    /**
     * Indexed list of WOE_HTMLPurifier_AttrTransform to be performed before validation.
     * @type WOE_HTMLPurifier_AttrTransform[]
     */
    public $info_attr_transform_pre = array();

    /**
     * Indexed list of WOE_HTMLPurifier_AttrTransform to be performed after validation.
     * @type WOE_HTMLPurifier_AttrTransform[]
     */
    ...
    /**
     * Indexed list of WOE_HTMLPurifier_Injector to be used.
     ...
     *       method in WOE_HTMLPurifier_HTMLModule
     ...
     *             WOE_HTMLPurifier_AttrTypes for details
     */
     ...
     * @see WOE_HTMLPurifier_HTMLModule::addElement() for detailed
     ...
     * @return WOE_HTMLPurifier_ElementDef
     * @see WOE_HTMLPurifier_HTMLModule::addBlankElement() for detailed
     *       parameter and return value descriptions.
     */
     ...
     * module.
     * @return WOE_HTMLPurifier_HTMLModule
     */
    public function getAnonymousModule()
    {
        if (!$this->_anonModule) {
            $this->_anonModule = new WOE_HTMLPurifier_HTMLModule();
    ...
    /**
     * @type WOE_HTMLPurifier_HTMLModuleManager
     */
    public $manager;
    ...
    {
        $this->manager = new WOE_HTMLPurifier_HTMLModuleManager();
    }
