...
class WOE_HTMLPurifier_HTMLModuleManager
{

    /**
     * @type WOE_HTMLPurifier_DoctypeRegistry
     */
    public $doctypes;
    ...
    /**
     * @type WOE_HTMLPurifier_AttrTypes
     */
    public $attrTypes;
     ...
     * @type WOE_HTMLPurifier_HTMLModule[]
     */
    public $modules = array();

    /**
     * Array of recognized WOE_HTMLPurifier_HTMLModule instances,
    ...
    /**
     * @type WOE_HTMLPurifier_ContentSets
     */
    public $contentSets;

    /**
     * @type WOE_HTMLPurifier_AttrCollections
     */
    ...
    public function __construct()
    {
        ...
        $this->attrTypes = new WOE_HTMLPurifier_AttrTypes();
        $this->doctypes  = new WOE_HTMLPurifier_DoctypeRegistry();
     ...
     *                WOE_HTMLPurifier_HTMLModule prefix, or instance of
     *                subclass of WOE_HTMLPurifier_HTMLModule.
    ...
    public function setup($config)
    {
        ...
        $this->contentSets = new WOE_HTMLPurifier_ContentSets(
            // content set assembly deals with all possible modules,
            // not just ones deemed to be "safe"
            $this->modules
        );
        $this->attrCollections = new WOE_HTMLPurifier_AttrCollections(
            $this->attrTypes,
     ...
     * @return Array of WOE_HTMLPurifier_ElementDef
     */
     ...
     * @return WOE_HTMLPurifier_ElementDef Merged WOE_HTMLPurifier_ElementDef
