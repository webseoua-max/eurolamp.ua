 ...
 */
class WOE_HTMLPurifier_Encoder
{
    ...
    {
        set_error_handler(array('WOE_HTMLPurifier_Encoder', 'muteErrorHandler'));
        $r = iconv($in, $out, $text);
     ...
     * Arguably this function should be modernized to the WOE_HTML5 set
    ...
    public static function convertToUTF8($str, $config, $context)
    {
        ...
        $bug = WOE_HTMLPurifier_Encoder::testIconvTruncateBug();
