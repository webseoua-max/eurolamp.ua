...
class NovaGlobalAddress extends AbstractShippingMethod
{
    public function __construct($instance_id = 0)
    {
        ...
        $this->method_title = __('Nova Global Address', 'wc-ukr-shipping-i18n');
    ...
    {
        return new CheckoutRateShipmentFactory(CarrierSlug::NOVA_GLOBAL);
    }
}
