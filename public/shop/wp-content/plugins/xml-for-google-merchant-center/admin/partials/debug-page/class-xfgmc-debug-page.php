...
/**
 * The class return the Debug page of the plugin XML for Google Merchant Center.
 *
...
class XFGMC_Debug_Page {
	...
	public function __construct() {
		...
		// симуляция запроса
		if ( isset( $_REQUEST['xfgmc_submit_action_simulation'] ) ) {
