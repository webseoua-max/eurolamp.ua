...
class XFGMC_Get_Unit_Offer_Variable extends XFGMC_Get_Unit_Offer {
	...
	use XFGMC_T_Variable_Get_Availability;
	use XFGMC_T_Variable_Get_Brand;
	use XFGMC_T_Variable_Get_Color;
	use XFGMC_T_Variable_Get_Condition;
	use XFGMC_T_Variable_Get_Custom_Label;
	use XFGMC_T_Variable_Get_Description;
	use XFGMC_T_Variable_Get_Dimensions;
	use XFGMC_T_Variable_Get_Fb_Product_Category;
	use XFGMC_T_Variable_Get_Gender;
	use XFGMC_T_Variable_Get_Google_Product_Category;
	use XFGMC_T_Variable_Get_Gtin;
	use XFGMC_T_Variable_Get_Id;
	use XFGMC_T_Variable_Get_Identifier_Exists;
	use XFGMC_T_Variable_Get_Image_Link;
	use XFGMC_T_Variable_Get_Is_Bundle;
	use XFGMC_T_Variable_Get_Item_Group_Id;
	use XFGMC_T_Variable_Get_Link;
	use XFGMC_T_Variable_Get_Material;
	use XFGMC_T_Variable_Get_Mobile_Link;
	use XFGMC_T_Variable_Get_Mpn;
	use XFGMC_T_Variable_Get_Multipack;
	use XFGMC_T_Variable_Get_Open_Item_Tag;
	use XFGMC_T_Variable_Get_Pattern;
	use XFGMC_T_Variable_Get_Price;
	use XFGMC_T_Variable_Get_Product_Type;
	use XFGMC_T_Variable_Get_Quantity;
	use XFGMC_T_Variable_Get_Sale_Price;
	use XFGMC_T_Variable_Get_Shipping;
	use XFGMC_T_Variable_Get_Shipping_Dimensions;
	use XFGMC_T_Variable_Get_Size_System;
	use XFGMC_T_Variable_Get_Size;
	use XFGMC_T_Variable_Get_Size_Type;
	use XFGMC_T_Variable_Get_Size;
	use XFGMC_T_Variable_Get_Store_Code;
	use XFGMC_T_Variable_Get_Tax_Category;
	use XFGMC_T_Variable_Get_Tax;
	use XFGMC_T_Variable_Get_Title;
	use XFGMC_T_Variable_Get_Unit_Pricing_Base_Measure;
	use XFGMC_T_Variable_Get_Unit_Pricing_Measure;
	 ...
	 * @return string
	 */
	public function get_variable_product_post_meta( $key, $prefix = '_xfgmc_' ) {
	 ...
	 *    - `xfgmc_f_variable_tag_value_{tag_name}`
	 *    - `xfgmc_f_variable_tag_name_{tag_name}`
	 *    - `xfgmc_f_variable_tag_{tag_name}`
	 * 
