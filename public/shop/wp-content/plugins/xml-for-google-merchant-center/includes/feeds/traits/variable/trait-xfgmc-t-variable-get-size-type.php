 ...
 */
trait XFGMC_T_Variable_Get_Size_Type {
	 ...
	 * 
	 * @return string Example: `<g:size_type_type>petite</g:size_type_type>`
	 */
	public function get_size_type( $tag_name = 'g:size_type', $result_xml = '' ) {
		...
		if ( $size_type === 'disabled' ) {
			...
			if ( empty( get_term_meta( $this->get_feed_category_id(), 'xfgmc_size_type', true ) )
				...
				$tag_value = $this->get_variable_global_attribute_value( $size_type );
			} else {
