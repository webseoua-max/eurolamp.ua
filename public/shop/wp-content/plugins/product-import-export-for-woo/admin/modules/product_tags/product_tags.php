...
if(!class_exists('Wt_Import_Export_For_Woo_Product_Basic_Product_Tags')){
class Wt_Import_Export_For_Woo_Product_Basic_Product_Tags {
...
new Wt_Import_Export_For_Woo_Product_Basic_Product_Tags();
