	...
	<div style="float:right;">
		<div style="float:right;">
	        ...
	        { 	
	        	...
	        	{
	        		?>
	        		<button class="button <?php echo esc_attr( $button_standard_class ); ?> wt_pf_export_action_btn <?php echo esc_attr( $css_class ); ?>" data-action-type="<?php echo esc_attr( $action_type ); ?>" data-action="<?php echo esc_attr( $btnv['key'] );?>" type="submit">
	        	...
	        	elseif($btnv['type']=='dropdown_button')
	        	{
	        		...
	        		?>
					<button type="button" class="button button-primary wt_pf_drp_menu <?php echo esc_attr( $css_class ); ?>" data-target="wt_pf_<?php echo esc_attr( $btnk ); ?>_drp">
	        	...
	        	{
	        		?>
	        		<button style="display:none;" class="button button-primary wt_pf_export_action_btn <?php echo esc_attr( $css_class ); ?>" data-action-type="<?php echo esc_attr( $action_type ); ?>" data-action="<?php echo esc_attr( $btnv['key'] );?>" type="submit">
			        	<?php echo wp_kses_post( $btnv['text'] );?>    		
			        </button>
	        		<?php
