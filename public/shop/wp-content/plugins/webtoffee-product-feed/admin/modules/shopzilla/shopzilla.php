	...
	class Webtoffee_Product_Feed_Sync_Shopzilla {
		...
		public function exporter_alter_mapping_enabled_fields($mapping_enabled_fields, $base, $form_data_mapping_enabled_fields) {
			if ($base == $this->module_base  || in_array($base, array('bizrate', 'become', 'price_grabber')) ) {
				...
				$mapping_enabled_fields['loyalty_points_jp'] = array(__('Loyalty Points (Japan Only)', 'webtoffee-product-feed'), 1);
				$mapping_enabled_fields['installment_brazil'] = array(__('Multiple Installments (Brazil Only)', 'webtoffee-product-feed'), 1);								
				$mapping_enabled_fields['shopping_action_attributes'] = array(__('Shopping Action Attributes', 'webtoffee-product-feed'), 1);				
			}
