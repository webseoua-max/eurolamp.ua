...
if (!class_exists('Webtoffee_Product_Feed_Sync_Fruugo')) {

	class Webtoffee_Product_Feed_Sync_Fruugo {
...
public function wt_fbfeed_category_form_fields_pro( $category ) {
	...
	?>
		...
		<tr class="form-field">
			...
			<th scope="row" valign="top"><label for="wt_fruugo_category"><?php esc_html_e('Fruugo Category', 'webtoffee-product-feed');?></label></th>
			<td>
		...
		echo wp_kses( wt_fruugo_category_dropdown( $fruugo_category_id ), $allowed_html ); 
		?>
				</select>

				<p class="description"><?php esc_html_e('The Fruugo Category corresponding to this category in the website.', 'webtoffee-product-feed')?>
				</p>
			</td>
		</tr>
	...
	public function wt_fbfeed_category_form_save_pro( $term_id ) {
		...
		public function exporter_do_export($export_data, $base, $step, $form_data, $selected_template_data, $method_export, $batch_offset) {
			...
			$export = new Webtoffee_Product_Feed_Sync_Fruugo_Export($this);
...
new Webtoffee_Product_Feed_Sync_Fruugo();



// Fruugo Category dropdown caching
if (!function_exists('wt_fruugo_category_dropdown')) {
    ...
    function wt_fruugo_category_dropdown($selected = '') {
        ...
        if (false === $category_dropdown) {
            $categories = Webtoffee_Product_Feed_Sync_Fruugo::get_category_array();
