 ...
 * @link          
 *
 * @package  Webtoffee_Product_Feed_Sync_Heureka
 */
if (!defined('ABSPATH')) {
	exit;
}

if (!class_exists('Webtoffee_Product_Feed_Sync_Heureka')) {

	class Webtoffee_Product_Feed_Sync_Heureka {
		...
		public function exporter_do_export($export_data, $base, $step, $form_data, $selected_template_data, $method_export, $batch_offset) {
			...
			$export = new Webtoffee_Product_Feed_Sync_Heureka_Export($this);
		...
		public function wt_pf_exporter_post_types_basic($arr) {
			...
			$arr['heureka'] = __('Heureka', 'webtoffee-product-feed');
			return $arr;
		}
...
new Webtoffee_Product_Feed_Sync_Heureka();
