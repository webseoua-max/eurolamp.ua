				...
				switch ($key) {
					case 'product_details':
						...
						//$fields[$key]['fields']['weight'] = 'Shipping Weight[shipping_weight]';
                                                $fields[$key]['fields']['image_link'] = 'Main Product Image';
                                                $fields[$key]['fields']['wtimages_1'] = 'Product Image 2';
                                                $fields[$key]['fields']['wtimages_2'] = 'Product Image 3';
                                                $fields[$key]['fields']['wtimages_3'] = 'Product Image 4';
                                                $fields[$key]['fields']['wtimages_4'] = 'Product Image 5';
                                                $fields[$key]['fields']['wtimages_5'] = 'Product Image 6';
                                                $fields[$key]['fields']['wtimages_6'] = 'Product Image 7';
                                                $fields[$key]['fields']['wtimages_7'] = 'Product Image 8';
                                                $fields[$key]['fields']['wtimages_8'] = 'Product Image 9';
						break;
			...
			return $fields;
                ...
                public function product_attributes_dropdown($attribute_dropdown, $export_channel, $selected=''){
                    ...
                    if( 'tiktokshop' === $export_channel ){
                        $max_variations = $this->get_max_variations_count_for_all_variable_products();
                        if( $max_variations > 0 ){  
                            $attribute_dropdown .= sprintf( '<optgroup label="%s">', esc_attr__( 'Variations', 'webtoffee-product-feed' ) );
                            for($i=1; $i<=$max_variations; $i++){
                ...
                public function get_max_variations_count_for_all_variable_products(){
                    ...
                    ", 'product_variation', 'publish'));//phpcs:ignore WordPress.DB.DirectDatabaseQuery.DirectQuery, WordPress.DB.DirectDatabaseQuery.NoCaching
