		...
		public static function debug_panel($module_base)
		{
			if($module_base=='import' || $module_base=='export')
			{
				$debug_panel_btns=array(
					'refresh_step'=>array(
						'title'=>__('Refresh the step', 'webtoffee-product-feed-pro'),
						'icon'=>'dashicons dashicons-update',
						'onclick'=>'wt_pf_basic_'.$module_base.'.refresh_step();',
					),
					'console_form_data'=>array(
						'title'=>__('Console form data', 'webtoffee-product-feed-pro'),
			...
			{
				?>
				<div class="wt_pf_debug_panel" title="<?php _e('For debugging process', 'webtoffee-product-feed-pro');?>">
					<div class="wt_pf_debug_panel_hd"><?php _e('Debug panel', 'webtoffee-product-feed-pro');?></div>
