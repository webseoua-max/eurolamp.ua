...
?>
<div class="wrap">
	<h2><?php esc_html_e( 'Attribute Mapping', 'webtoffee-product-feed-pro' ); ?></h2>
...
<?php wp_nonce_field( 'wt-attribute-mapping' ); ?>
		...
		<table class="table tree widefat fixed ">
			<thead>
				<tr>
					<th><?php esc_html_e( 'Local Attributes', 'webtoffee-product-feed-pro' ); ?></th>
					<th><?php esc_html_e( 'Facebook Attributes', 'webtoffee-product-feed-pro' ); ?></th>
				</tr>
			</thead>
			<tbody>
<?php wt_fbfeed_render_attributes( 0, '', $value ); ?>
			...
			<tfoot>
				<tr>
					<td colspan="2">
						<button  type="submit" class="button button-large button-primary"><?php esc_html_e( 'Save Mapping', 'webtoffee-product-feed-pro' ); ?></button>
					</td>
				</tr>
			</tfoot>
		</table>
