...
if ( !class_exists( 'WT_Fb_Catalog_Manager_Pro_Settings' ) ) :

	/**
	 * Uninstall feedback class
	 */
	class WT_Fb_Catalog_Manager_Pro_Settings {

		/** @var string base settings page ID */
		const PAGE_ID = 'webtoffee-product-feed-pro';
		...
		/**
		 * Gets the available FB categories - can be updated when new category added.
		 *
		 * @since 1.0.0
		 *
		 * @return $fb_categories[]
		 */
	...
	new WT_Fb_Catalog_Manager_Pro_Settings();
endif;
