...
class Webtoffee_Product_Feed_Sync_Pro_Review_Request
{
	...
	public function wt_product_feed_pro_init_review_request() {
        ...
        $this->banner_message = sprintf(__("Hey, we at %sWebToffee%s would like to thank you for using our plugin. We would really appreciate if you could take a moment to drop a quick review that will inspire us to keep going.", 'webtoffee-product-feed-pro'), '<b>', '</b>');

        /* button texts */
        $this->later_btn_text   = __("Remind me later", 'webtoffee-product-feed-pro');
        $this->never_btn_text   = __("Not interested", 'webtoffee-product-feed-pro');
        $this->review_btn_text  = __("Review now", 'webtoffee-product-feed-pro');
