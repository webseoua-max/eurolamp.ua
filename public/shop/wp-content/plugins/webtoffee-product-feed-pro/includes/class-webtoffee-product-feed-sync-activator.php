 ...
 */
class Webtoffee_Product_Feed_Sync_Pro_Activator {
...
public static function activate() 
	{
            if ( is_plugin_active( 'webtoffee-product-feed/webtoffee-product-feed.php' ) ) {
                deactivate_plugins( 'webtoffee-product-feed/webtoffee-product-feed.php' );
            }
	...
	public static function install_tables()
	{
		...
		//creating table for saving facebook sync data================
        $search_query = "SHOW TABLES LIKE %s";
        $tb='wt_pf_facebook_sync';
        $like = '%'.$wpdb->prefix.$tb.'%';
        $table_name = $wpdb->prefix.$tb;
        if(!$wpdb->get_results($wpdb->prepare($search_query, $like), ARRAY_N)) 
        {
        ...
        //creating table for saving facebook sync log data start ================
        ...
        //creating table for saving facebook sync log data end ================           
