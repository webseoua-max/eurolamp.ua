...
class Webtoffee_Product_Feed_Sync_Pro {
	...
	public function __construct() {
		...
		$this->plugin_name = 'webtoffee-product-feed-pro';
	...
	private function define_admin_hooks() {
		...
		$this->loader->add_action('wp_ajax_wt_pf_save_settings_pro',$plugin_admin,'save_settings');
                $this->loader->add_action('wp_ajax_wt_pf_save_settings_pro_custom_fields',$plugin_admin,'save_settings_custom_fields');
		
		$this->loader->add_action( 'admin_action_' . WT_Fb_Catalog_Manager_Pro_Settings::DISCONNECT_ACTION, $plugin_admin, 'handle_disconnect' );
