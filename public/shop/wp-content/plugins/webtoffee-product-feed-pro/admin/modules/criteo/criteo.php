 ...
 * @link          
 *
 * @package  Webtoffee_Product_Feed_Sync_Pro_Criteo 
 */
if (!defined('ABSPATH')) {
	exit;
}

if (!class_exists('Webtoffee_Product_Feed_Sync_Pro_Criteo')) {

	class Webtoffee_Product_Feed_Sync_Pro_Criteo {

		public $module_id = '';
		public static $module_id_static = '';
		public $module_base = 'criteo';
		public $module_name = 'Webtoffee Product Feed Catlaog for Criteo';
		...
		public function exporter_do_export($export_data, $base, $step, $form_data, $selected_template_data, $method_export, $batch_offset) {
			...
			$export = new Webtoffee_Product_Feed_Sync_Pro_Criteo_Export($this);
		...
		public function wt_pf_exporter_post_types_basic($arr) {
			...
			$arr['criteo'] = __('Criteo', 'webtoffee-product-feed-pro');
			return $arr;
		}
		...
		public function exporter_alter_mapping_enabled_fields($mapping_enabled_fields, $base, $form_data_mapping_enabled_fields) {
			if ($base === $this->module_base) {
				...
				$mapping_enabled_fields['shipping'] = array(__('Shipping', 'webtoffee-product-feed-pro'), 1);
...
new Webtoffee_Product_Feed_Sync_Pro_Criteo();