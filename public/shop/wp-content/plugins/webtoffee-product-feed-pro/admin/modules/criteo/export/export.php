...
if (!class_exists('Webtoffee_Product_Feed_Sync_Pro_Criteo_Export')) {

    class Webtoffee_Product_Feed_Sync_Pro_Criteo_Export extends Webtoffee_Product_Feed_Pro_Product {
        ...
        public function material($catalog_attr, $product_attr, $export_columns) {
            ...
            return apply_filters('wt_feed_product_criteo_material', $material, $this->product);
        }
        ...
        public function pattern($catalog_attr, $product_attr, $export_columns) {
            ...
            return apply_filters('wt_feed_product_criteo_pattern', $pattern, $this->product);
        }
        ...
        public function unit_pricing_measure($catalog_attr, $product_attr, $export_columns) {
            ...
            return apply_filters('wt_feed_product_criteo_unit_pricing_measure', $unit_pricing_measure, $this->product);
        }
        ...
        public function unit_pricing_base_measure($catalog_attr, $product_attr, $export_columns) {
            ...
            return apply_filters('wt_feed_product_criteo_unit_pricing_base_measure', $unit_pricing_base_measure, $this->product);
        }
        ...
        public function energy_efficiency_class($catalog_attr, $product_attr, $export_columns) {
            ...
            return apply_filters('wt_feed_product_criteo_energy_efficiency_class', $energy_efficiency_class, $this->product);
        }
        ...
        public function min_energy_efficiency_class($catalog_attr, $product_attr, $export_columns) {
            ...
            return apply_filters('wt_feed_product_criteo_min_energy_efficiency_class', $min_energy_efficiency_class, $this->product);
        }
        ...
        public function max_energy_efficiency_class($catalog_attr, $product_attr, $export_columns) {
            ...
            return apply_filters('wt_feed_product_criteo_max_energy_efficiency_class', $max_energy_efficiency_class, $this->product);
        }
        ...
        /**
         * Criteo Formatted Shipping info
         *
         */
        ...
        public function custom_label_0($catalog_attr, $product_attr, $export_columns) {
            ...
            return apply_filters('wt_feed_product_criteo_custom_label_0', $custom_label_0, $this->product);
        }
        ...
        public function custom_label_1($catalog_attr, $product_attr, $export_columns) {
            ...
            return apply_filters('wt_feed_product_criteo_custom_label_1', $custom_label_1, $this->product);
        }
        ...
        public function custom_label_2($catalog_attr, $product_attr, $export_columns) {
            ...
            return apply_filters('wt_feed_product_criteo_custom_label_2', $custom_label_2, $this->product);
        }
        ...
        public function custom_label_3($catalog_attr, $product_attr, $export_columns) {
            ...
            return apply_filters('wt_feed_product_criteo_custom_label_3', $custom_label_3, $this->product);
        }
        ...
        public function custom_label_4($catalog_attr, $product_attr, $export_columns) {
            ...
            return apply_filters('wt_feed_product_criteo_custom_label_4', $custom_label_4, $this->product);
        }
        ...
        /** Get Criteo Sale Price effective date.
         *
         * @return string
         */
