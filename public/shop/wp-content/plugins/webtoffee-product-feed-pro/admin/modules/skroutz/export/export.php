...
if (!class_exists('Webtoffee_Product_Feed_Sync_Pro_Skroutz_Export')) {

    class Webtoffee_Product_Feed_Sync_Pro_Skroutz_Export extends Webtoffee_Product_Feed_Pro_Product {
        ...
        public function price_with_vat($catalog_attr, $product_attr, $export_columns) {
