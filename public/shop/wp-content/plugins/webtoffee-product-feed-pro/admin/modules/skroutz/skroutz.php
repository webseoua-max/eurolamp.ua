 ...
 * @link          
 *
 * @package  Webtoffee_Product_Feed_Sync_Pro_Skroutz 
 */
if (!defined('ABSPATH')) {
	exit;
}

if (!class_exists('Webtoffee_Product_Feed_Sync_Pro_Skroutz')) {

	class Webtoffee_Product_Feed_Sync_Pro_Skroutz {
		...
		public function __construct() {
			...
			if ('skroutz' === $to_export) {
				...
				$advanced_screen_fields['file_as']['sele_vals'] = array( 'xml' => __('XML', 'webtoffee-product-feed-pro' ));				
			}
		...
		public function exporter_do_export($export_data, $base, $step, $form_data, $selected_template_data, $method_export, $batch_offset) {
			...
			$export = new Webtoffee_Product_Feed_Sync_Pro_Skroutz_Export($this);
		...
		public function wt_pf_exporter_post_types_basic($arr) {
			...
			$arr['skroutz'] = __('Skroutz', 'webtoffee-product-feed-pro');
			return $arr;
		}
			...
			foreach ($fields as $key => $value) {
				switch ($key) {
					case 'availability_price':
						...
						$fields[$key]['fields']['price_with_vat'] = 'Regular Price[price]';
                                                $fields[$key]['fields']['vat'] = 'VAT[tax]';
...
new Webtoffee_Product_Feed_Sync_Pro_Skroutz();
