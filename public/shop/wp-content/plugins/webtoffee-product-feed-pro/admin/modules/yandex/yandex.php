 ...
 * @link          
 *
 * @package  Webtoffee_Product_Feed_Sync_Pro_Yandex
 */
if (!defined('ABSPATH')) {
	exit;
}

if (!class_exists('Webtoffee_Product_Feed_Sync_Pro_Yandex')) {

	class Webtoffee_Product_Feed_Sync_Pro_Yandex {
	...
	if ( isset( $_POST[ 'wt_google_category' ] ) ) {
		...
		public function exporter_do_export($export_data, $base, $step, $form_data, $selected_template_data, $method_export, $batch_offset) {
			...
			$export = new Webtoffee_Product_Feed_Sync_Pro_Yandex_Export($this);
...
new Webtoffee_Product_Feed_Sync_Pro_Yandex();
