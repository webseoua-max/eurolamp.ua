...
if (!class_exists('Webtoffee_Product_Feed_Sync_Pro_Yandex_Export')) {

    class Webtoffee_Product_Feed_Sync_Pro_Yandex_Export extends Webtoffee_Product_Feed_Pro_Product {
