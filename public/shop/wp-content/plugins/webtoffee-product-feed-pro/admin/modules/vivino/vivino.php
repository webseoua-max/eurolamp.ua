...
if (!class_exists('Webtoffee_Product_Feed_Sync_Pro_Vivino')) {

    class Webtoffee_Product_Feed_Sync_Pro_Vivino {
        ...
        public function exporter_do_export($export_data, $base, $step, $form_data, $selected_template_data, $method_export, $batch_offset) {
            ...
            $export = new Webtoffee_Product_Feed_Sync_Pro_Vivino_Export($this);
...
new Webtoffee_Product_Feed_Sync_Pro_Vivino();
