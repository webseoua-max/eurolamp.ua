...
<div class="wt-wrap">
    ...
    <span><?php esc_html_e('Fruugo has it\'s own', 'webtoffee-product-feed-pro'); ?> <a target="_blank" href="https://fruugo.atlassian.net/wiki/spaces/RR/pages/67792527/Mapping+Category+Tree?preview=/67792527/67874831/Fruugo_Mapping_Categories.xlsx"><?php esc_html_e('category list', 'webtoffee-product-feed-pro'); ?></a>. <?php esc_html_e(' It is mandatory to map the store categories against Fruugo categories. To edit the mapping go to the respective', 'webtoffee-product-feed-pro'); ?> <a target="_blank" href="<?php echo admin_url('edit-tags.php?taxonomy=product_cat&post_type=product'); ?>"><?php esc_html_e('categories page', 'webtoffee-product-feed-pro'); ?></a></span>
