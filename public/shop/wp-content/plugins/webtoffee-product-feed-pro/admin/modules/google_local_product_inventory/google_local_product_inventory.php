	...
	class Webtoffee_Product_Feed_Google_Local_Product_Inventory {
		...
		public function wt_exporter_set_delimeter_default($advanced_screen_fields, $to_export, $advanced_form_data) {
			...
			if ('google_local_product_inventory' === $to_export) {
				...
				$advanced_screen_fields['delimiter']['sele_vals'] = array('tab' => array('value' => __('Tab', 'webtoffee-product-feed-pro' ), 'val' => "\t"));
		...
		public function wt_pf_exporter_post_types_basic($arr) {
			...
			$arr['google_local_product_inventory'] = __('Google Local Product Inventory', 'webtoffee-product-feed-pro');
			return $arr;
		}
