 ...
 * @link          
 *
 * @package  Webtoffee_Product_Feed_Sync_Pro_PriceSpy 
 */
if (!defined('ABSPATH')) {
	exit;
}

if (!class_exists('Webtoffee_Product_Feed_Sync_Pro_PriceSpy')) {

	class Webtoffee_Product_Feed_Sync_Pro_PriceSpy {
	...
	if ( isset( $_POST[ 'wt_google_category' ] ) ) {
		...
		public function exporter_do_export($export_data, $base, $step, $form_data, $selected_template_data, $method_export, $batch_offset) {
			...
			$export = new Webtoffee_Product_Feed_Sync_Pro_PriceSpy_Export($this);
		...
		public function wt_pf_exporter_post_types_basic($arr) {
			...
			$arr['pricespy'] = __('PriceSpy', 'webtoffee-product-feed-pro');
			return $arr;
		}
...
new Webtoffee_Product_Feed_Sync_Pro_PriceSpy();
			...
			if (!function_exists('wt_google_category_dropdown')) {
				...
				function wt_google_category_dropdown($selected = '') {
					...
					if (false === $category_dropdown) {
						$categories = Webtoffee_Product_Feed_Sync_Pro_PriceSpy::get_category_array();
