 ...
 * @link          
 *
 * @package  Webtoffee_Product_Feed_Sync_Pro_Rakuten 
 */
if (!defined('ABSPATH')) {
	exit;
}

if (!class_exists('Webtoffee_Product_Feed_Sync_Pro_Rakuten')) {

	class Webtoffee_Product_Feed_Sync_Pro_Rakuten {
		...
		public function exporter_do_export($export_data, $base, $step, $form_data, $selected_template_data, $method_export, $batch_offset) {
			...
			$export = new Webtoffee_Product_Feed_Sync_Pro_Rakuten_Export($this);
			...
			foreach ($fields as $key => $value) {
				switch ($key) {
					case 'availability_price':
						$fields[$key]['fields']['availability'] = __('Stock Status[availability]', 'webtoffee-product-feed-pro');
						$fields[$key]['fields']['availability_date'] = __('Availability Date[availability_date]', 'webtoffee-product-feed-pro');
						$fields[$key]['fields']['price'] = __('Regular Price[price]', 'webtoffee-product-feed-pro');
						$fields[$key]['fields']['sale_price'] = __('Sale Price[sale_price]', 'webtoffee-product-feed-pro');
						$fields[$key]['fields']['sale_price_effective_date'] = __('Sale Price Effective Date[sale_price_effective_date]', 'webtoffee-product-feed-pro');
						break;

					case 'unique_product_identifiers':

						$fields[$key]['fields']['brand'] = __('Manufacturer[brand]', 'webtoffee-product-feed-pro');
						$fields[$key]['fields']['gtin'] = __('GTIN[gtin]', 'webtoffee-product-feed-pro');
						$fields[$key]['fields']['mpn'] = __('MPN[mpn]', 'webtoffee-product-feed-pro');
						break;
...
new Webtoffee_Product_Feed_Sync_Pro_Rakuten();
			...
			if (!function_exists('wt_google_category_dropdown')) {
				...
				function wt_google_category_dropdown($selected = '') {
					...
					if (false === $category_dropdown) {
						$categories = Webtoffee_Product_Feed_Sync_Pro_Rakuten::get_category_array();
