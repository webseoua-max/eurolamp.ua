 ...
 * @link          
 *
 * @package  Webtoffee_Product_Feed_Sync_Pro_OnBuy 
 */
if (!defined('ABSPATH')) {
	exit;
}

if (!class_exists('Webtoffee_Product_Feed_Sync_Pro_OnBuy')) {

	class Webtoffee_Product_Feed_Sync_Pro_OnBuy {
	...
	?>
		...
		<?php echo wt_onbuy_category_dropdown( $fb_category_id ); ?>
				...
				<p class="description"><?php esc_html_e('The OnBuy Category corresponding to this category in the website.', 'webtoffee-product-feed-pro');?>
				</p>
			</td>
		</tr>
	...
	if ( isset( $_POST[ 'wt_onbuy_category' ] ) ) {
		...
		public function exporter_do_export($export_data, $base, $step, $form_data, $selected_template_data, $method_export, $batch_offset) {
			...
			$export = new Webtoffee_Product_Feed_Sync_Pro_OnBuy_Export($this);
		...
		public function wt_pf_exporter_post_types_basic($arr) {
			...
			$arr['onbuy'] = __('OnBuy', 'webtoffee-product-feed-pro');
			return $arr;
		}
		...
		public function exporter_alter_mapping_enabled_fields($mapping_enabled_fields, $base, $form_data_mapping_enabled_fields) {
			if ($base === $this->module_base) {
				...
				$mapping_enabled_fields['listing_details'] = array(__('Listing Details', 'webtoffee-product-feed-pro'), 1);
				$mapping_enabled_fields['recommended_details'] = array(__('Recommended Details', 'webtoffee-product-feed-pro'), 1);
				$mapping_enabled_fields['variation_data'] = array(__('Variation Data', 'webtoffee-product-feed-pro'), 1);
				$mapping_enabled_fields['features'] = array(__('Features', 'webtoffee-product-feed-pro'), 1);
				$mapping_enabled_fields['additional_product_data'] = array(__('Additional product data', 'webtoffee-product-feed-pro'), 1);
				$mapping_enabled_fields['optional_listing_details'] = array(__('Optional Listing Details', 'webtoffee-product-feed-pro'), 1);
...
new Webtoffee_Product_Feed_Sync_Pro_OnBuy();
