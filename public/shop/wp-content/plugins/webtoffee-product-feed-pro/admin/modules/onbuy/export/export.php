...
if (!class_exists('Webtoffee_Product_Feed_Sync_Pro_OnBuy_Export')) {

    class Webtoffee_Product_Feed_Sync_Pro_OnBuy_Export extends Webtoffee_Product_Feed_Pro_Product {
...
/**
                ...
                foreach ($category_path as $category) {
                    ...
                    if ($onbuy_category_id) {
                        ...
                        if (false === $onbuy_category_list) {
                            $onbuy_category_list = Webtoffee_Product_Feed_Sync_Pro_OnBuy::get_category_array();
 ...
 /**
        ...
        public function mpn($catalog_attr, $product_attr, $export_columns) {
            ...
            if ('' == $custom_mpn) {
                $custom_mpn = get_post_meta($this->product->get_id(), '_wt_onbuy_mpn', true);
            }
