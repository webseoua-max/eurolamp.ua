 ...
 * @link          
 *
 * @package  Webtoffee_Product_Feed_Sync_Pro_Leguide 
 */
if (!defined('ABSPATH')) {
	exit;
}

if (!class_exists('Webtoffee_Product_Feed_Sync_Pro_Leguide')) {

	class Webtoffee_Product_Feed_Sync_Pro_Leguide {
		...
		public function exporter_do_export($export_data, $base, $step, $form_data, $selected_template_data, $method_export, $batch_offset) {
			...
			$export = new Webtoffee_Product_Feed_Sync_Pro_Leguide_Export($this);
		...
		public function wt_pf_exporter_post_types_basic($arr) {
			...
			$arr['leguide'] = __('Leguide', 'webtoffee-product-feed-pro');
			return $arr;
		}
...
new Webtoffee_Product_Feed_Sync_Pro_Leguide();
