 ...
 * @link          
 *
 * @package  Webtoffee_Product_Feed_Sync_Pro_PriceRunner 
 */
if (!defined('ABSPATH')) {
	exit;
}

if (!class_exists('Webtoffee_Product_Feed_Sync_Pro_PriceRunner')) {

	class Webtoffee_Product_Feed_Sync_Pro_PriceRunner {
	...
	if ( isset( $_POST[ 'wt_google_category' ] ) ) {
		...
		public function exporter_do_export($export_data, $base, $step, $form_data, $selected_template_data, $method_export, $batch_offset) {
			...
			$export = new Webtoffee_Product_Feed_Sync_Pro_PriceRunner_Export($this);
		...
		public function wt_pf_exporter_post_types_basic($arr) {
			...
			$arr['pricerunner'] = __('PriceRunner', 'webtoffee-product-feed-pro');
			return $arr;
		}
		...
		public function fn_wt_pf_exporter_steps_basic($steps, $to_export) {
			...
			return $steps;
                ...
                public function product_attributes_dropdown($attribute_dropdown, $export_channel, $selected=''){
                    ...
                    if( 'pricerunner' === $export_channel ){
                        
                        $attribute_dropdown .= sprintf( '<option value="%s">%s</option>', 'ShippingCost', 'ShippingCost[ShippingCost]' );                       
...
new Webtoffee_Product_Feed_Sync_Pro_PriceRunner();
			...
			if (!function_exists('wt_google_category_dropdown')) {
				...
				function wt_google_category_dropdown($selected = '') {
					...
					if (false === $category_dropdown) {
						$categories = Webtoffee_Product_Feed_Sync_Pro_PriceRunner::get_category_array();
