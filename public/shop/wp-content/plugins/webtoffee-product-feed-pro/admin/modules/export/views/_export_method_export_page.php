...
<div class="wt_pf_export_main">
    ...
    <div class="wt_pf_warn wt_pf_method_export_wrn" style="display:none;">
		<?php _e('Please select an export method', 'webtoffee-product-feed-pro');?>
	</div>

    <div class="wt_pf_warn wt_pf_export_template_wrn" style="display:none;">
        <?php _e('Please select an export template.', 'webtoffee-product-feed-pro');?>
    </div>
    <div id="product-type-message" class="updated" style="margin:0px;display: none;background: #dceff4;"><p><?php esc_html_e('The free version of this plugin exports and imports only WooCommerce Simple, Grouped and External/Affiliate product types.', 'webtoffee-product-feed-pro'); ?></p></div>
	<table class="form-table wt-pfd-form-table">
		<tr>
			<th><label><?php _e('Select an export method', 'webtoffee-product-feed-pro');?></label></th>
        ...
        <tr class="wt-pfd-export-method-options wt-pfd-export-method-options-quick">
            <th style="width:150px; text-align:left; vertical-align:top;"><label><?php _e('Include fields from the respective groups', 'webtoffee-product-feed-pro');?></label></th>
            <td colspan="2" style="width:75%;">
                <?php
                ...
                ?>
                <span class="wt-iew_form_help"><?php _e('Enabling any of these ensures that all the fields from the respective groups are included in your export.', 'webtoffee-product-feed-pro');?></span>
            </td>
        </tr>
		<?php endif; ?>

		<tr class="wt-pfd-export-method-options wt-pfd-export-method-options-template" style="display:none;">
    		<th><label><?php _e('Export template', 'webtoffee-product-feed-pro');?></label></th>
    		<td>
    			<select class="wt-pfd-export-template-sele">
    				<option value="0">-- <?php _e('Select a template', 'webtoffee-product-feed-pro'); ?> --</option>
    				<?php
