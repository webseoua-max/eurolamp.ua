...
if (!class_exists('Webtoffee_Product_Feed_Sync_Pro_Bing_Export')) {

    class Webtoffee_Product_Feed_Sync_Pro_Bing_Export extends Webtoffee_Product_Feed_Pro_Product {
        ...
        public function sale_price_with_tax($catalog_attr, $product_attr, $export_columns) {
            ...
            // Only proceed if there is an actual sale price
            if (empty($sprice)) {
                return '';
            }
