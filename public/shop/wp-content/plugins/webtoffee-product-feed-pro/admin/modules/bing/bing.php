 ...
 * @link          
 *
 * @package  Webtoffee_Product_Feed_Sync_Pro_Bing 
 */
if (!defined('ABSPATH')) {
	exit;
}

if (!class_exists('Webtoffee_Product_Feed_Sync_Pro_Bing')) {

	class Webtoffee_Product_Feed_Sync_Pro_Bing {
	...
	if ( isset( $_POST[ 'wt_google_category' ] ) ) {
		...
		public function exporter_do_export($export_data, $base, $step, $form_data, $selected_template_data, $method_export, $batch_offset) {
			...
			$export = new Webtoffee_Product_Feed_Sync_Pro_Bing_Export($this);
		...
		public function wt_pf_exporter_post_types_basic($arr) {
			...
			$arr['bing'] = __('Bing Shopping', 'webtoffee-product-feed-pro');
			return $arr;
		}
		...
		public static function get_category_array() {
			...
			$fileName = WT_PRODUCT_FEED_PRO_PLUGIN_PATH . '/admin/modules/bing/data/google_taxonomy.txt';
		...
		public function exporter_alter_mapping_enabled_fields($mapping_enabled_fields, $base, $form_data_mapping_enabled_fields) {
			if ($base == $this->module_base) {
				...
				$mapping_enabled_fields['tax_shipping'] = array(__('Shipping', 'webtoffee-product-feed-pro'), 1);
				...
				switch ($key) {
					...
					case 'tax_shipping':
						$fields[$key]['fields']['shipping'] = 'Shipping';
                                                //$fields[$key]['fields']['shipping_cp'] = 'shipping(country:price)';
                                                //$fields[$key]['fields']['shipping_csp'] = 'shipping(country:service:price)';
						break;
...
new Webtoffee_Product_Feed_Sync_Pro_Bing();
			...
			if (!function_exists('wt_google_category_dropdown')) {
				...
				function wt_google_category_dropdown($selected = '') {
					...
					if (false === $category_dropdown) {
						$categories = Webtoffee_Product_Feed_Sync_Pro_Bing::get_category_array();
