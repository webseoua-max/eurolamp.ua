...
if (!class_exists('Webtoffee_Product_Feed_Custom')) {

	class Webtoffee_Product_Feed_Custom {
		...
		public function wt_exporter_set_delimeter_default($advanced_screen_fields, $to_export, $advanced_form_data) {
			...
			if ('custom' === $to_export) {
				...
				$advanced_screen_fields['delimiter']['sele_vals'] = array( 'comma' => array('value' => __('Comma', 'webtoffee-product-feed-pro'), 'val' => ","), 'semicolon' => array('value' => __('Semicolon', 'webtoffee-product-feed-pro'), 'val' => ";"), 'tab' => array('value' => __('Tab', 'webtoffee-product-feed-pro' ), 'val' => "\t"));
				...
				$advanced_screen_fields['delimiter']['help_text']= __( 'Separator for differentiating the columns in the CSV file. Only Tab is supported for Google Local Product Inventory', 'webtoffee-product-feed-pro' );
			}
		...
		public function wt_pf_exporter_post_types_basic($arr) {
			...
			$arr['custom'] = __('Custom Feed', 'webtoffee-product-feed-pro');
			return $arr;
		}
		...
		public function exporter_alter_advanced_fields($fields, $base, $advanced_form_data) {
			...
			if ('custom' === $base) {
				...
				$out['delimiter']['sele_vals'] = array(
					...
					'pipe' => array('value' => __('Pipe', 'webtoffee-product-feed-pro'), 'val' => "|"),
...
new Webtoffee_Product_Feed_Custom();
