...
<div class="wt_productfeed_schedule_now wt_productfeed_popup">
	<div class="wt_productfeed_popup_hd">
		...
		<span class="wt_productfeed_popup_hd_label"><?php _e('Schedule now', 'webtoffee-product-feed-pro');?></span>
		<div class="wt_productfeed_popup_close">X</div>
	</div>
	<div class="wt_productfeed_schedule_now_box">
		<div class="wt_productfeed_cron_current_time"><b><?php _e('Current server time:', 'webtoffee-product-feed-pro');?></b> <span>--:--:-- --</span><br/>
		
			<?php 
			$wt_time_zone = Webtoffee_Product_Feed_Sync_Pro_Common_Helper::get_advanced_settings('default_time_zone'); 
			if(!$wt_time_zone){
			?>
			<data><?php	esc_html_e( 'To switch to your website timezone', 'webtoffee-product-feed-pro'); ?> <a href="<?php echo admin_url('admin.php?page=wt_import_export_for_woo');?>" target="_blank" style="text-decoration:none;"> <?php esc_html_e( 'click here', 'webtoffee-product-feed-pro' ); ?> <em class="dashicons dashicons-external"></em></a></data>
			<?php } ?>
			
		</div>

		<label><?php _e('Schedule type', 'webtoffee-product-feed-pro');?></label>
		<div class="wt_productfeed_schedule_now_formrow">
			<div class="wt_productfeed_schedule_type_box_single" style="margin-bottom:0px;">
				<label for="wt_productfeed_schedule_wordpress_cron"><input type="radio" name="wt_productfeed_schedule_type" id="wt_productfeed_schedule_wordpress_cron" value="wordpress_cron" checked="checked"> <?php _e('Wordpress Cron', 'webtoffee-product-feed-pro');?> </label>
			...
			<div class="wt_productfeed_schedule_type_box_single">
				<label for="wt_productfeed_schedule_server_cron"><input type="radio" name="wt_productfeed_schedule_type" id="wt_productfeed_schedule_server_cron" value="server_cron"> <?php _e('Server Cron', 'webtoffee-product-feed-pro');?> </label>
		...
		{
		?>
		<label><?php _e('File name', 'webtoffee-product-feed-pro');?></label>
		<div class="wt_productfeed_schedule_now_formrow">
			<input type="text" name="wt_productfeed_cron_file_name" value="" /> <span class="wt_productfeed_cron_file_ext">.csv</span>
			<br />	
			<?php _e('Specify a filename for the exported file(the contents of this file will be overwritten for every export). If left blank the system generates a default name(a new filename is generated for every export).', 'webtoffee-product-feed-pro'); ?>	
		</div>
		<?php
		}
		?>

		<label><?php _e('Interval', 'webtoffee-product-feed-pro');?></label>
		<div class="wt_productfeed_schedule_now_formrow">			
			<div class="wt_productfeed_schedule_now_interval_radio_block">
				<label for="wt_productfeed_cron_interval_day"><input type="radio" id="wt_productfeed_cron_interval_day" name="wt_productfeed_cron_interval" value="day" checked="checked"> <?php _e('Every day', 'webtoffee-product-feed-pro');?></label>
				<label for="wt_productfeed_cron_interval_week"><input type="radio" id="wt_productfeed_cron_interval_week" name="wt_productfeed_cron_interval" value="week"> <?php _e('Every week', 'webtoffee-product-feed-pro');?></label>
				<!-- <label for="wt_productfeed_cron_interval_biweek"><input type="radio" id="wt_productfeed_cron_interval_biweek" name="wt_productfeed_cron_interval" value="biweek"> <?php _e('Biweekly', 'webtoffee-product-feed-pro');?></label> -->
				<label for="wt_productfeed_cron_interval_month"><input type="radio" id="wt_productfeed_cron_interval_month" name="wt_productfeed_cron_interval" value="month"> <?php _e('Every month', 'webtoffee-product-feed-pro');?></label>
				<label for="wt_productfeed_cron_interval_custom"><input type="radio" id="wt_productfeed_cron_interval_custom" name="wt_productfeed_cron_interval" value="custom"> <?php _e('Custom', 'webtoffee-product-feed-pro');?></label>
			</div>
			<div class="wt_productfeed_schedule_now_interval_sub_block wt_productfeed_schedule_custom_interval_block">
				<label><?php _e('Custom interval', 'webtoffee-product-feed-pro');?></label>
				<input type="number" step="1" min="1" name="wt_productfeed_cron_interval_val" value="" placeholder="<?php _e('Interval in minutes.', 'webtoffee-product-feed-pro');?>">
				<span class="wt-iew_form_help" style="margin-top:3px;"><?php _e('Recommended: Minimum 2 hour(120 minutes)', 'webtoffee-product-feed-pro');?></span>
			</div>
			<div class="wt_productfeed_schedule_now_interval_sub_block wt_productfeed_schedule_day_block">
				<label><?php _e('Which day?', 'webtoffee-product-feed-pro');?></label>
				<div class="wt_productfeed_schedule_now_interval_radio_block">				
					<?php
			...
			<div class="wt_productfeed_schedule_now_interval_sub_block wt_productfeed_schedule_date_block">
				<label><?php _e('Day of the Month?', 'webtoffee-product-feed-pro');?></label>
			...
			<div class="wt_productfeed_schedule_now_interval_sub_block wt_productfeed_schedule_starttime_block">
				<label><?php _e('Start time', 'webtoffee-product-feed-pro');?></label> 
		...
		<div class="wt_productfeed_schedule_now_trigger_url">
			<label><?php _e('Trigger URL', 'webtoffee-product-feed-pro');?></label>
			<div class="wt_productfeed_schedule_now_formrow" style="margin-bottom:0px;">
				<input type="text" name="wt_productfeed_cron_url" value="" />
				<p style="color:red; margin:0px;"><?php _e('Use the generated URL to run cron.', 'webtoffee-product-feed-pro'); ?></p>
		...
		<div class="wt_productfeed_popup_footer">
			...
			<button type="button" name="" class="button-primary wt_productfeed_save_schedule"><?php _e('Schedule now', 'webtoffee-product-feed-pro');?></button>	
		</div>
	</div>
</div>