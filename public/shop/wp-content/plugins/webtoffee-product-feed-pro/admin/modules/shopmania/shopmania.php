 ...
 * @link          
 *
 * @package  Webtoffee_Product_Feed_Sync_Pro_Shopmania 
 */
if (!defined('ABSPATH')) {
	exit;
}

if (!class_exists('Webtoffee_Product_Feed_Sync_Pro_Shopmania')) {

	class Webtoffee_Product_Feed_Sync_Pro_Shopmania {
		...
		public function exporter_do_export($export_data, $base, $step, $form_data, $selected_template_data, $method_export, $batch_offset) {
			...
			$export = new Webtoffee_Product_Feed_Sync_Pro_Shopmania_Export($this);
		...
		public function wt_pf_exporter_post_types_basic($arr) {
			...
			$arr['shopmania'] = __('Shopmania', 'webtoffee-product-feed-pro');
			return $arr;
		}
...
new Webtoffee_Product_Feed_Sync_Pro_Shopmania();
			...
			if (!function_exists('wt_google_category_dropdown')) {
				...
				function wt_google_category_dropdown($selected = '') {
					...
					if (false === $category_dropdown) {
						$categories = Webtoffee_Product_Feed_Sync_Pro_Shopmania::get_category_array();
