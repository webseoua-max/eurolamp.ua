...
<div class="wt-wrap">
	...
	<h4><?php esc_html_e( 'Map WooCommerce categories with Google categories.', 'webtoffee-product-feed-pro' ); ?></h4>
	<?php
	...
	<form action="" name="feed" id="category-mapping-form" class="category-mapping-form" method="post" autocomplete="off">
		...
		<table class="table tree widefat fixed wt-pf-category-default-mapping-tb">
			...
			<tr>
				...
				<th><?php esc_html_e( 'Google Category', 'webtoffee-product-feed-pro' ); ?></th>
			</tr>
			</thead>
			<tbody>
