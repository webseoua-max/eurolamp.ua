...
if (!class_exists('Webtoffee_Product_Feed_Sync_Pro_TiktokShop_Export')) {

    class Webtoffee_Product_Feed_Sync_Pro_TiktokShop_Export extends Webtoffee_Product_Feed_Pro_Product {
                ...
                foreach ($category_path as $category) {
                    ...
                    if ($tiktok_category_id) {
                        ...
                        if (false === $tiktok_category_list) {
                            $tiktok_category_list = Webtoffee_Product_Feed_Sync_Pro_TiktokShop::get_category_array();
