...
if (!class_exists('Webtoffee_Product_Feed_Sync_Pro_TiktokShop')) {

	class Webtoffee_Product_Feed_Sync_Pro_TiktokShop {
		...
		public function exporter_do_export($export_data, $base, $step, $form_data, $selected_template_data, $method_export, $batch_offset) {
			...
			$export = new Webtoffee_Product_Feed_Sync_Pro_TiktokShop_Export($this);
		...
		public function wt_pf_exporter_post_types_basic($arr) {
			...
			$arr['tiktokshop'] = __('TikTok Shop', 'webtoffee-product-feed-pro');
			return $arr;
		}
			...
			return $fields;
                ...
                public function product_attributes_dropdown($attribute_dropdown, $export_channel, $selected=''){
                    ...
                    if( 'tiktokshop' === $export_channel ){
                        $max_variations = $this->get_max_variations_count_for_all_variable_products();
                        if( $max_variations > 0 ){  
                            $attribute_dropdown .= sprintf( '<optgroup label="%s">', esc_attr__( 'Variations', 'webtoffee-product-feed-pro' ) );
                            for($i=1; $i<=$max_variations; $i++){
...
new Webtoffee_Product_Feed_Sync_Pro_TiktokShop();
