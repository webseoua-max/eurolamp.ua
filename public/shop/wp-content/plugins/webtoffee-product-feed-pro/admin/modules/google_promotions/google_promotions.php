	...
	class Webtoffee_Product_Feed_Google_Promotions {
		...
		public function wt_exporter_set_delimeter_default($advanced_screen_fields, $to_export, $advanced_form_data) {
			...
			if ('google_promotions' === $to_export) {
				...
				$advanced_screen_fields['delimiter']['help_text']= __( 'Separator for differentiating the columns in the CSV file. Only Tab is supported for Google Promotions', 'webtoffee-product-feed-pro' );
			}
		...
		public function wt_pf_exporter_post_types_basic($arr) {
			...
			$arr['google_promotions'] = __('Google Promotions', 'webtoffee-product-feed-pro');
			return $arr;
		}
