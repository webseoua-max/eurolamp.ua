...
if (!class_exists('Webtoffee_Product_Feed_Sync_Pro_Pinterest_Export')) {

    class Webtoffee_Product_Feed_Sync_Pro_Pinterest_Export extends Webtoffee_Product_Feed_Pro_Product {
