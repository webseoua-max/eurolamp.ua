...
if (!class_exists('Webtoffee_Product_Feed_Sync_Pro_Pinterest')) {

	class Webtoffee_Product_Feed_Sync_Pro_Pinterest {
		...
		public function exporter_do_export($export_data, $base, $step, $form_data, $selected_template_data, $method_export, $batch_offset) {
			...
			$export = new Webtoffee_Product_Feed_Sync_Pro_Pinterest_Export($this);
		...
		public function wt_pf_exporter_post_types_basic($arr) {
			...
			$arr['pinterest'] = __('Pinterest', 'webtoffee-product-feed-pro');
			return $arr;
		}
		...
		public function exporter_alter_mapping_enabled_fields($mapping_enabled_fields, $base, $form_data_mapping_enabled_fields) {
			if ($base == $this->module_base) {
				...
				$mapping_enabled_fields['availability_price'] = array(__('Price Details', 'webtoffee-product-feed-pro'), 1);
...
new Webtoffee_Product_Feed_Sync_Pro_Pinterest();
