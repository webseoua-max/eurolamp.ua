 ...
 * @link          
 *
 * @package  Webtoffee_Product_Feed_Sync_Pro_Shopzilla 
 */
if (!defined('ABSPATH')) {
	exit;
}

if (!class_exists('Webtoffee_Product_Feed_Sync_Pro_Shopzilla')) {

	class Webtoffee_Product_Feed_Sync_Pro_Shopzilla {
	...
	if ( isset( $_POST[ 'wt_google_category' ] ) ) {
		...
		public function exporter_do_export($export_data, $base, $step, $form_data, $selected_template_data, $method_export, $batch_offset) {
			...
			$export = new Webtoffee_Product_Feed_Sync_Pro_Shopzilla_Export($this);
		...
		public function wt_pf_exporter_post_types_basic($arr) {
			...
			$arr['shopzilla'] = __('Shopzilla', 'webtoffee-product-feed-pro');
                        $arr['bizrate'] = __('Bizrate', 'webtoffee-product-feed-pro');
                        $arr['become'] = __('Become', 'webtoffee-product-feed-pro');
                        $arr['price_grabber'] = __('Price grabber', 'webtoffee-product-feed-pro');
			return $arr;
		}
		...
		public function exporter_alter_mapping_enabled_fields($mapping_enabled_fields, $base, $form_data_mapping_enabled_fields) {
			if ($base == $this->module_base  || in_array($base, array('bizrate', 'become', 'price_grabber')) ) {
				...
				$mapping_enabled_fields['product_combinations'] = array(__('Product Combinations', 'webtoffee-product-feed-pro'), 1);
				$mapping_enabled_fields['adult_products'] = array(__('Adult Products', 'webtoffee-product-feed-pro'), 1);
				$mapping_enabled_fields['ads_attributes'] = array(__('Ads Attributes', 'webtoffee-product-feed-pro'), 1);
				...
				$mapping_enabled_fields['unit_prices_eu_ch'] = array(__('Unit Prices (EU Countries and Switzerland Only)', 'webtoffee-product-feed-pro'), 1);
				$mapping_enabled_fields['energy_labels'] = array(__('Energy Labels', 'webtoffee-product-feed-pro'), 1);
				$mapping_enabled_fields['loyalty_points_jp'] = array(__('Loyalty Points (Japan Only)', 'webtoffee-product-feed-pro'), 1);
				$mapping_enabled_fields['installment_brazil'] = array(__('Multiple Installments (Brazil Only)', 'webtoffee-product-feed-pro'), 1);								
				$mapping_enabled_fields['shopping_action_attributes'] = array(__('Shopping Action Attributes', 'webtoffee-product-feed-pro'), 1);				
			}
...
new Webtoffee_Product_Feed_Sync_Pro_Shopzilla();
