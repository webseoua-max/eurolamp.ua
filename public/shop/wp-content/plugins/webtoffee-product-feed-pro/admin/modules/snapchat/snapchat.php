...
if (!class_exists('Webtoffee_Product_Feed_Sync_Pro_Snapchat')) {
	...
	?>
		...
		<tr class="form-field">
			<th scope="row" valign="top"><label for="wt_google_category"><?php _e('Google Category', 'webtoffee-product-feed-pro'); ?></label></th>
			<td>
	...
	if ( isset( $_POST[ 'wt_google_category' ] ) ) {
		...
		public function wt_pf_exporter_post_types_basic($arr) {
			...
			$arr['snapchat'] = __('Snapchat', 'webtoffee-product-feed-pro');
			return $arr;
		}
