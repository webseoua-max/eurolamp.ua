	...
	var wt_pf_basic_history=
	{
		...
		view_raw_log:function(log_file)
		{
			...
			$.ajax({
				...
				data:{'action':'iew_history_ajax_pro', _wpnonce:wt_pf_basic_params.nonces.main, 'history_action':'view_log', 'log_file':log_file, 'data_type':'json'},
				type:'post',
				dataType:"json",
		...
		load_page:function(history_id)
		{
			...
			$.ajax({
				url:wt_pf_basic_params.ajax_url,
				data:{'action':'iew_history_ajax_pro', _wpnonce:wt_pf_basic_params.nonces.main, 'history_action':'view_log', 'offset': offset, 'history_id':history_id, 'data_type':'json'},
				type:'post',
				dataType:"json",
				success:function(data)
				{
                ...
                reg_duplicate:function()
		{
			jQuery('.wt_pf_export_duplicate_btn').click(function(){
                            ...
                            $.ajax({
				url:wt_pf_basic_params.ajax_url,
				data:{'action':'pf_feed_duplicate', _wpnonce:wt_pf_basic_params.nonces.main, 'cron_id':cron_id, 'force_refresh': true},
				type:'post',
				dataType:"json",
				success:function(data)
				{
