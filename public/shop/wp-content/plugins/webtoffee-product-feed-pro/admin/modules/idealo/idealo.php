...
if (!class_exists('Webtoffee_Product_Feed_Sync_Pro_Idealo')) {
	...
	?>
		...
		<?php echo wt_google_category_dropdown( $fb_category_id ); ?>
				...
				<p class="description"><?php esc_html_e('The Google Category corresponding to this category in the website.', 'webtoffee-product-feed-pro');?>
				</p>
			</td>
		</tr>
	...
	if ( isset( $_POST[ 'wt_google_category' ] ) ) {
		...
		public function wt_pf_exporter_post_types_basic($arr) {
			...
			$arr['idealo'] = __('Idealo', 'webtoffee-product-feed-pro');
			return $arr;
		}
		...
		public function exporter_alter_mapping_enabled_fields($mapping_enabled_fields, $base, $form_data_mapping_enabled_fields) {
			if ($base == $this->module_base) {
				...
				$mapping_enabled_fields['detailed_product_attributes'] = array(__('Detailed Product Attributes', 'webtoffee-product-feed-pro'), 1);
                                $mapping_enabled_fields['payment_and_delivery'] = array(__('Payment and Delivery', 'webtoffee-product-feed-pro'), 1);
				$mapping_enabled_fields['energy_labels'] = array(__('Energy Labels', 'webtoffee-product-feed-pro'), 1);
			...
			foreach ($fields as $key => $value) {
				switch ($key) {
					...
					case 'payment_and_delivery':
						...
						$fields[$key]['fields'][ 'deliveryTime'] = __( 'deliveryTime', 'webtoffee-product-feed-pro' );
						$fields[$key]['fields'][ 'paymentCosts_credit_card'] = __( 'paymentCosts_credit_card', 'webtoffee-product-feed-pro' );
						$fields[$key]['fields'][ 'paymentCosts_cash_in_advance'] = __( 'paymentCosts_cash_in_advance', 'webtoffee-product-feed-pro' );
						$fields[$key]['fields'][ 'paymentCosts_cash_on_delivery'] = __( 'paymentCosts_cash_on_delivery', 'webtoffee-product-feed-pro' );
						$fields[$key]['fields'][ 'paymentCosts_direct_debit'] = __( 'paymentCosts_direct_debit', 'webtoffee-product-feed-pro' );
						$fields[$key]['fields'][ 'paymentCosts_paypal'] = __( 'paymentCosts_paypal', 'webtoffee-product-feed-pro' );
						$fields[$key]['fields'][ 'paymentCosts_giropay'] = __( 'paymentCosts_giropay', 'webtoffee-product-feed-pro' );
						$fields[$key]['fields'][ 'paymentCosts_google_checkout'] = __( 'paymentCosts_google_checkout', 'webtoffee-product-feed-pro' );
						$fields[$key]['fields'][ 'paymentCosts_invoice'] = __( 'paymentCosts_invoice', 'webtoffee-product-feed-pro' );
						$fields[$key]['fields'][ 'paymentCosts_postal_order'] = __( 'paymentCosts_postal_order', 'webtoffee-product-feed-pro' );
						$fields[$key]['fields'][ 'paymentCosts_paysafecard'] = __( 'paymentCosts_paysafecard', 'webtoffee-product-feed-pro' );
						$fields[$key]['fields'][ 'paymentCosts_sofortueberweisung'] = __( 'paymentCosts_sofortueberweisung', 'webtoffee-product-feed-pro' );
						$fields[$key]['fields'][ 'paymentCosts_amazon_payment'] = __( 'paymentCosts_amazon_payment', 'webtoffee-product-feed-pro' );
						$fields[$key]['fields'][ 'paymentCosts_electronical_payment_standard'] = __( 'paymentCosts_electronical_payment_standard', 'webtoffee-product-feed-pro' );
						$fields[$key]['fields'][ 'paymentCosts_ecotax'] = __( 'paymentCosts_ecotax', 'webtoffee-product-feed-pro' );                        

						$fields[$key]['fields'][ 'deliveryCost_spedition'] = __( 'deliveryCost_spedition', 'webtoffee-product-feed-pro' );
						$fields[$key]['fields'][ 'deliveryCost_trans_o_flex'] = __( 'deliveryCost_trans_o_flex', 'webtoffee-product-feed-pro' );
						$fields[$key]['fields'][ 'deliveryCost_tnt'] = __( 'deliveryCost_tnt', 'webtoffee-product-feed-pro' );
						$fields[$key]['fields'][ 'deliveryCost_pick_point'] = __( 'deliveryCost_pick_point', 'webtoffee-product-feed-pro' );
						$fields[$key]['fields'][ 'deliveryCost_hermes'] = __( 'deliveryCost_hermes', 'webtoffee-product-feed-pro' );
						$fields[$key]['fields'][ 'deliveryCost_gls_think_green'] = __( 'deliveryCost_gls_think_green', 'webtoffee-product-feed-pro' );
						$fields[$key]['fields'][ 'deliveryCost_gls'] = __( 'deliveryCost_gls', 'webtoffee-product-feed-pro' );
						$fields[$key]['fields'][ 'deliveryCost_german_express_logistics'] = __( 'deliveryCost_german_express_logistics', 'webtoffee-product-feed-pro' );
						$fields[$key]['fields'][ 'deliveryCost_dpd'] = __( 'deliveryCost_dpd', 'webtoffee-product-feed-pro' );
						$fields[$key]['fields'][ 'deliveryCost_download'] = __( 'deliveryCost_download', 'webtoffee-product-feed-pro' );
						$fields[$key]['fields'][ 'deliveryCost_dhl_go_green'] = __( 'deliveryCost_dhl_go_green', 'webtoffee-product-feed-pro' );
						$fields[$key]['fields'][ 'deliveryCost_dhl'] = __( 'deliveryCost_dhl', 'webtoffee-product-feed-pro' );
						$fields[$key]['fields'][ 'deliveryCost_deutsche_post'] = __( 'deliveryCost_deutsche_post', 'webtoffee-product-feed-pro' );
						$fields[$key]['fields'][ 'deliveryCost_fedex'] = __( 'deliveryCost_fedex', 'webtoffee-product-feed-pro' );
						$fields[$key]['fields'][ 'deliveryCost_ups'] = __( 'deliveryCost_ups', 'webtoffee-product-feed-pro' );
						break;
