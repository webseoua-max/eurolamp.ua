...
if (!class_exists('Webtoffee_Product_Feed_Sync_Pro_Idealo_Export')) {
    ...
    class Webtoffee_Product_Feed_Sync_Pro_Idealo_Export extends Webtoffee_Product_Feed_Pro_Product {
        ...
        public function url($catalog_attr, $product_attr, $export_columns) {
            ...
            return apply_filters('wt_feed_filter_product_link', $link, $this->product, $this->form_data);
        }
       ...
       public function colour($catalog_attr, $product_attr, $export_columns) {
        ...
        /**
         * Get GLS Delivery Cost.
         * @return string
         */
        public function deliveryCost_gls($catalog_attr, $product_attr, $export_columns) {
            $delivery_cost = ''; // Empty default - filter will determine the value
            
            return apply_filters('wt_feed_filter_delivery_cost_gls', $delivery_cost, $this->product, $this->form_data);
        }
