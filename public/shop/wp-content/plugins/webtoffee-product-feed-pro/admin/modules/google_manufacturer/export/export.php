...
if (!class_exists('Webtoffee_Product_Feed_Sync_Pro_Google_Manufacturer_Export')) {

    class Webtoffee_Product_Feed_Sync_Pro_Google_Manufacturer_Export extends Webtoffee_Product_Feed_Pro_Product {
        ...
        public function prepare_data_to_export($form_data, $batch_offset, $step) {
            ...
            $parent_variations_qty = !empty($form_data['post_type_form_data']['wt_pf_parent_qty']) ? $form_data['post_type_form_data']['wt_pf_parent_qty'] : '';
         ...
         * @return mixed|void
         */
        public function product_line($catalog_attr, $product_attr, $export_columns) {
            $title = '';
            ...
            return apply_filters('wt_feed_filter_product_product_line', $title, $this->product);
        }
        ...
        public function product_name($catalog_attr, $product_attr, $export_columns) {
            ...
            return apply_filters('wt_feed_filter_product_product_name', $title, $this->product);
        }        
         ...
         * @return mixed|void
         */
        public function product_page_url($catalog_attr, $product_attr, $export_columns) {
            $link = $this->product->get_permalink();
            if ($this->product->is_type('variation')) {
                $link = $this->parent_product->get_permalink();
            }

            return apply_filters('wt_feed_filter_product_page_link', $link, $this->product);
        }
         ...
         * @return mixed|void
         */
        public function video_link($catalog_attr, $product_attr, $export_columns) {
            $link = '';
            return apply_filters('wt_feed_filter_product_video_link', $link, $this->product);
        }        
         ...
         * @return mixed|void
         */
        public function product_detail($catalog_attr, $product_attr, $export_columns) {
            $product_details = array();
            
            $attributes = $this->additional_variant_attribute($catalog_attr, $product_attr, $export_columns);

            if(!empty($attributes)){
                $i = 0;
                foreach ( $attributes as $attribute ) {
                    $product_details[$i]['section_name'] = 'General';
                    $product_details[$i]['attribute_name'] = $attribute['label'];
                    $product_details[$i]['attribute_value'] = $attribute['value'];
                    $i++;
                }
            
            }
            
            return apply_filters('wt_feed_google_manufacturer_product_details', $product_details, $this->product);
        }          
         ...
         * @return mixed|void
         */
        public function product_highlight($catalog_attr, $product_attr, $export_columns) {
            $product_highlight = array();
            
            
            return apply_filters('wt_feed_google_manufacturer_product_highlight', $product_highlight, $this->product);
        }    
       ...
       /**
         ...
         * @return mixed|void
         */
        public function feature_description($catalog_attr, $product_attr, $export_columns) {
            $feature_description = array();
            
            return apply_filters('wt_feed_google_manufacturer_product_feature_description', $feature_description, $this->product);
        }        
        ...
        public function canonical_link($catalog_attr, $product_attr, $export_columns) {
            ...
            return apply_filters('wt_feed_google_manufacturer_product_canonical_link', $canonical_link, $this->product);
        }
        ...
        public function suggested_retail_price($catalog_attr, $product_attr, $export_columns) {
         ...
         * @return mixed|void
         */
        public function disclosure_date($catalog_attr, $product_attr, $export_columns) {
            $date_created = gmdate('Y-m-d', strtotime($this->product->get_date_created()));

            return apply_filters('wt_feed_filter_product_disclosure_date', $date_created, $this->product);
        }
         ...
         * @return mixed|void
         */
        public function release_date($catalog_attr, $product_attr, $export_columns) {
            $date_updated = gmdate('Y-m-d', strtotime($this->product->get_date_modified()));

            return apply_filters('wt_feed_filter_product_release_date', $date_updated, $this->product);
        }
