...
if (!class_exists('Webtoffee_Product_Feed_Sync_Pro_Heureka_Export')) {

    class Webtoffee_Product_Feed_Sync_Pro_Heureka_Export extends Webtoffee_Product_Feed_Pro_Product {
                    ...
                    if( $product->is_type( 'variation' ) ){                        
                        ...
                        if(!empty( $product_data )){
                            ...
                            foreach($product_data as $product_data_single){
                                $product_array_processed['PARAM'][$param_count]['PARAM_NAME'] = $product_data_single['label'];
        ...
        protected function generate_row_data_wc_lower($product_object) {
            ...
            foreach ($export_columns as $key => $value) {
				...
				$value = trim( $value );
                    ...
                    if(isset($this->heureka_xml_keys[$key])){
                        $row[$this->heureka_xml_keys[$key]] = $row[$key];
                        unset($row[$key]);
                    }
                }else {
                    $row[$key] = '';
