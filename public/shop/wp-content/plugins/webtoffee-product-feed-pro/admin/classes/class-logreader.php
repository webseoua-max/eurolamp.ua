 ...
 * @link       
 *
 * @package  Webtoffee_Product_Feed_Sync_Pro_Logreader 
 */
if (!defined('ABSPATH')) {
    exit;
}
if(!class_exists('Webtoffee_Product_Feed_Sync_Pro_Logreader')){
class Webtoffee_Product_Feed_Sync_Pro_Logreader
{
	private $file_path='';
