 ...
 * @link       
 *
 * @package  Webtoffee_Product_Feed_Sync_Pro_Logwriter 
 */
if (!defined('ABSPATH')) {
    exit;
}
if(!class_exists('Webtoffee_Product_Feed_Sync_Pro_Logwriter')){
class Webtoffee_Product_Feed_Sync_Pro_Logwriter extends Webtoffee_Product_Feed_Sync_Pro_Log
{
