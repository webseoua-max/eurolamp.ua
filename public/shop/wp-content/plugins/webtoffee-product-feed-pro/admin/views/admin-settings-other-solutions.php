...
.wt_heading_1{text-align:center;font-style: normal;font-weight: bold;font-size: 82px;display: block !important;}
...
<div class="wt-pfd-tab-content" data-id="<?php echo esc_attr($target_id); ?>">
    <div class="wt_row"> 
        <div clas="wt_headings">
            <h1 class="wt_heading_1"><?php _e('More Plugins To Make Your Store Stand Out', 'webtoffee-product-feed-pro'); ?></h1>
            <h2 class="wt_heading_2"><?php _e('Check out our other plugins that are perfectly suited for WooCommerce store needs.', 'webtoffee-product-feed-pro'); ?></h2> 
        </div>
    <div class="wt_column">
<?php 

/* image location for the logos */
$wt_admin_img_path = WT_PRODUCT_FEED_PRO_PLUGIN_URL . 'assets/images/other_solutions';

/* Plugin lists array */
$plugins=array(
    'product_feed_sync' => array(
        'title'         => __('WebToffee WooCommerce Product Feed & Sync Manager', 'webtoffee-product-feed-pro'),
        'description'   => __('Generate WooCommerce product feeds for Google Merchant Center and Facebook Business Manager. Use the Facebook catalog sync manager to sync WooCommerce products with Facebook and Instagram shops.', 'webtoffee-product-feed-pro'),
    ...
    'request_quote' => array(
        'title'         => __('WebToffee Woocommerce Request a Quote', 'webtoffee-product-feed-pro'),
        'description'   => __('Configure a fully optimized WooCommerce quote request set up in your store. Allow customers to request quotes and store managers to respond to them. Hide product prices, set up email alerts, and more.', 'webtoffee-product-feed-pro'),
    ...
    'giftcards_plugin' => array(
        'title'         => __('WebToffee WooCommerce Gift Cards', 'webtoffee-product-feed-pro'),
        'description'   => __('Create and manage advanced gift cards for WooCommerce stores. Enable your customers to buy, redeem, and share gift cards from your store.', 'webtoffee-product-feed-pro'),
    ...
    'fbt_plugins' => array(
        'title'         => __('Frequently Bought Together for WooCommerce', 'webtoffee-product-feed-pro'),
        'description'   => __('Boost the visibility of the products by displaying them as ‘Frequently bought together’ items in your store. You may also set up discounts for Frequently Bought Together bundles with this plugin.', 'webtoffee-product-feed-pro'),
    ...
    'gdpr_cookie_consent_plugin' => array(
        'title'         => __('GDPR Cookie Consent Plugin (CCPA Ready)', 'webtoffee-product-feed-pro'),
        'description'   => __('The plugin helps you get compliant with GDPR, CCPA, and other major cookie laws. You can create and manage cookie consent banners, scan website cookies, and generate cookie policies with this plugin.','webtoffee-product-feed-pro'),
    ...
    'product_import_export_plugin' => array(
        'title'         => __('Product Import Export Plugin For WooCommerce', 'webtoffee-product-feed-pro'),
        'description'   => __('Seamlessly import/export your WooCommerce products including simple, variable, custom products and subscriptions. You may also import and export product images, tags, categories, reviews, and ratings.', 'webtoffee-product-feed-pro'),
    ...
    'customers_import_export_plugin' => array(
        'title'         => __('WordPress Users & WooCommerce Customers Import Export', 'webtoffee-product-feed-pro'),
        'description'   => __('Easily import and export your WordPress users and WooCommerce customers using the Import Export plugin for WooCommerce. The plugin supports the use of CSV, XML, TSV, XLS, and XLSX file formats.', 'webtoffee-product-feed-pro'),
    ...
    'order_import_export_plugin' => array(
        'title'         => __('Order, Coupon, Subscription Export Import for WooCommerce', 'webtoffee-product-feed-pro'),
        'description'   => __('Export and Import your WooCommerce orders, subscriptions, and discount coupons using a single Import Export plugin. You may customize the export and import files with advanced filters and settings.', 'webtoffee-product-feed-pro'),
    ...
    'import_export_suit' => array(
        'title'         => __('Import Export Suite for WooCommerce', 'webtoffee-product-feed-pro'),
        'description'   => __('An all-in-one plugin to import and export WooCommerce store data. You can import and export products, product reviews, orders, customers, discount coupons, and subscriptions using this single plugin.', 'webtoffee-product-feed-pro'),
    ...
    'smart_coupons_plugin' => array(
        'title'         => __('Smart Coupons for WooCommerce', 'webtoffee-product-feed-pro'),
        'description'   => __('Create coupons to offer discounts and free products to your customers with Smart Coupons for WooCommerce. You can set up BOGO coupons, giveaways, gift cards, store credits, and more with this plugin.', 'webtoffee-product-feed-pro'),
    ...
    'url_coupons_plugin' => array(
        'title'         => __('URL Coupons for WooCommerce', 'webtoffee-product-feed-pro'),
        'description'   => __('Generate custom URLs and QR codes for every discount coupon in your WooCommerce store. These unique coupons are easy to share and can even be set to add new products to the cart upon application.', 'webtoffee-product-feed-pro'),
    ...
    'sequential_order_plugin' => array(
        'title' => __('Sequential Order Numbers for WooCommerce', 'webtoffee-product-feed-pro'),
        'description' => __('Number your WooCommerce orders in a custom, sequential & manageable format. The Sequential Order Number plugin lets your orders follow a custom & unique numbering sequence suitable for your business.', 'webtoffee-product-feed-pro'),
	...
	'wt_ipc_addon' => array(
        'title'         => __('WooCommerce PDF Invoices, Packing Slips and Credit Notes', 'webtoffee-product-feed-pro'),
        'description'   => __('Easily generate & print fully customized PDF Invoices, Packing Slips, and Credit Notes for your orders. Automatically send the documents to the recipients by attaching them to the order status emails.', 'webtoffee-product-feed-pro'),
    ...
    'wt_sdd_addon' => array(
        'title'         => __('WooCommerce Shipping Labels, Dispatch Labels and Delivery Notes', 'webtoffee-product-feed-pro'),
        'description'   => __('Automatically generate WooCommerce Shipping Labels, Dispatch Labels, and Delivery Notes with custom settings and layouts. Customize the label sizes and add extra product or order fields as required.', 'webtoffee-product-feed-pro'),
    ...
    'wt_pl_addon' => array(
        'title'         => __('WooCommerce Picklists', 'webtoffee-product-feed-pro'),
        'description'   => __('Customize, generate and print WooCommerce picklists for all orders on your store and automatically attach them to the order status emails. Add product variation data and other fields to the document.', 'webtoffee-product-feed-pro'),
    ...
    'wt_pi_addon' => array(
        'title'         => __('WooCommerce Proforma Invoices', 'webtoffee-product-feed-pro'),
        'description'   => __('Automate the generation of WooCommerce proforma invoices when new orders are placed and send them to your customers via order emails. Customize the layout and content of the invoice as per your needs.', 'webtoffee-product-feed-pro'),
    ...
    'wt_al_addon' => array(
        'title'         => __('WooCommerce Address Labels', 'webtoffee-product-feed-pro'),
        'description'   => __('Generate address labels for all orders in your store and easily print them in bulk. Customize the label layout and create labels of different types (shipping, billing, return, from address) with ease.', 'webtoffee-product-feed-pro'),
            ...
            <div class="wt_widget">
                ...
                <div class="wt_buttons">
                    <div class="wt_premium_button" style="width: 100%;">
                        <a href="<?php echo esc_url($value['premium_url']); ?>" class="wt_get_premium_btn" target="_blank"><img src="<?php echo esc_url($wt_admin_img_path . '/promote_crown.png');?>" style="width: 10px;height: 10px;"><?php  _e(' Get Premium','webtoffee-product-feed-pro'); ?></a>
                    </div> 
<?php
...
?>
                    <div class="wt_installed_button">
                        <button class="wt_installed_btn">
                            <?php _e('Installed','webtoffee-product-feed-pro'); ?>
                        </button>
                    </div>
<?php               
                    ...
                    <div class="wt_free_button">
                        <a class="wt_free_btn_a" href="<?php echo esc_url($value['basic_url']); ?>" target="_blank">
                            <button class="wt_free_btn">
                                <?php _e('Get Free Plugin','webtoffee-product-feed-pro'); ?>
                            </button>
                        </a>
                    </div>
