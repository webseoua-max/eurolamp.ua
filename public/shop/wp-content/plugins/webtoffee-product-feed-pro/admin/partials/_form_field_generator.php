	...
	if($tr_html=="")
	{
		...
		<tr <?php echo $tr_id.$field_group_attr;?> class="<?php echo $tr_class;?>"  <?php echo $form_toggler_child; ?>>
			...
			<td <?php echo $colspan_attr;?> class="<?php echo $td_class2;?>">
				...
				if($field_html=='')
				{
					...
					elseif($type=='image_export') //image export radio button
					{
						...
						<div class="wt_form_radio_block">
							<?php
							$radio_fields=array(
				                'Yes' => __('Yes', 'webtoffee-product-feed-pro'),
				                'No' => __('No', 'webtoffee-product-feed-pro')
				            );
							foreach ($radio_fields as $rad_vl=>$rad_label) 
							{
							?>
					...
					}elseif($type=='uploader')
					{
						...
						<div class="wt_pf_file_attacher_dv">
							...
							<input type="button" name="upload_file" data-wt_pf_file_attacher_title="<?php _e('Choose a file.', 'webtoffee-product-feed-pro'); ?>"  data-wt_pf_file_attacher_button_text="<?php _e('Select', 'webtoffee-product-feed-pro'); ?>" class="wf_button button button-primary wt_pf_file_attacher" wt_pf_file_attacher_target="#<?php echo $field_id; ?>" value="<?php _e('Upload', 'webtoffee-product-feed-pro'); ?>" />
						</div>
						<?php
					}elseif($type=='dropzone') /* dropzone file uploader */
					{
						...
						<div id="<?php echo $dropzone_id;?>" class="wt_pf_dropzone" wt_pf_dropzone_target="#<?php echo $field_id; ?>">
							<div class="dz-message">
								<?php _e('Drag and Drop', 'webtoffee-product-feed-pro'); ?>
								<?php _e('or', 'webtoffee-product-feed-pro'); ?>
								<?php _e(' Click and Upload', 'webtoffee-product-feed-pro');?>
				...
				{
					?>
					<span class="wt-pf_form_help"><?php echo $help_text;?></span>
					<?php
				}
				?>
			</td>
