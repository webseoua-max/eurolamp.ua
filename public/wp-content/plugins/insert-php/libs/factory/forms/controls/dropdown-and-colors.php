<?php
	 ...
	 *  // see FactoryForms475_DropdownControl
	 * 'dropdown' => array(
	 ...
	 *    ),
	 * // see FactoryForms475_RadioColorsControl
	 * 'colors' => array(
	 *   // a callback to return items or an array of items to select
	 *   'data' => array(
	...
	if( !class_exists('Wbcr_FactoryForms475_DropdownAndColorsControl') ) {
		
		class Wbcr_FactoryForms475_DropdownAndColorsControl extends Wbcr_FactoryForms475_ComplexControl {
			...
			public function __construct($options, $form, $provider = null)
			{
				...
				$this->dropdown = new Wbcr_FactoryForms475_DropdownControl($options['dropdown'], $form, $provider);
				$this->colors = new Wbcr_FactoryForms475_RadioColorsControl($options['colors'], $form, $provider);
