<?php
	...
	if( !class_exists('Wbcr_FactoryForms475_Bootstrap3FormLayout') ) {
		/**
		 * A form layout based on Twitter Bootstrap 3
		 */
		class Wbcr_FactoryForms475_Bootstrap3FormLayout extends Wbcr_FactoryForms475_FormLayout {
			...
			/**
			 * @param Wbcr_FactoryForms475_Control $control
			 */
