<?php
	...
	if( !class_exists('Wbcr_FactoryForms475_OptionsValueProvider') ) {
		 ...
		 * @since 1.0.0
		 */
		class Wbcr_FactoryForms475_OptionsValueProvider implements Wbcr_IFactoryForms475_ValueProvider {
