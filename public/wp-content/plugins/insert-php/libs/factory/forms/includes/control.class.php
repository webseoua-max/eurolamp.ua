<?php
	...
	if( !class_exists('Wbcr_FactoryForms475_Control') ) {
		 ...
		 * @since 1.0.0
		 */
		abstract class Wbcr_FactoryForms475_Control extends Wbcr_FactoryForms475_FormElement {
			 ...
			 *
			 * @param mixed[] $options
			 * @param FactoryForms475_Form $form
			 * @param null $provider
			 * @since 1.0.0
			 * @return void
			 */
			 ...
			 *
			 * @since 1.0.0
			 * @param IFactoryForms475_ValueProvider $provider
			 * @return void
			 */
