...
namespace WBCR\Factory_Freemius_165\Premium;

use WBCR\Factory_Freemius_165\Entities\License;
use WBCR\Factory_Freemius_165\Entities\Plugin;
use WBCR\Factory_Freemius_165\Entities\Site;
use WBCR\Factory_Freemius_165\Entities\User;
use WBCR\Factory_475\Premium\Provider as License_Provider;
use Wbcr_Factory475_Plugin;
use WBCR\Factory_Freemius_165\Api;
use WP_Error;
use Exception;
...
final class Provider extends License_Provider {
	...
	/**
	 * @var \WBCR\Factory_Freemius_165\Api
	 */
	private $site_api;
	 ...
	 * @throws Exception
	 */
	public function __construct(Wbcr_Factory475_Plugin $plugin, array $settings)
	{
	...
	/**
	 * @return \WBCR\Factory_Freemius_165\Entities\License|null
	 * @throws Exception
	 */
	 ...
	 * @param bool $flush
	 *
	 * @return \WBCR\Factory_Freemius_165\Api
	 * @throws Exception
	 */
