...
abstract class Wbcr_Factory475_Plugin extends Wbcr_Factory475_Base {
	 ...
	 * Wbcr_FactoryTypes415_Type, а затем регистрирует его через этот метод. Метод выполняет
	 ...
	 *                             Регистрируемый класс должен быть унаследован от класса Wbcr_FactoryTypes415_Type.
	 * @param string $file_path Абсолютный путь к файлу с классом страницы.
	 *
	 * @throws Exception
