<?php
	...
	if( !class_exists('Wbcr_FactoryForms480_FormElement') ) {
		 ...
		 * @since 1.0.0
		 */
		abstract class Wbcr_FactoryForms480_FormElement {
			 ...
			 *
			 * @since 1.0.0
			 * @var Wbcr_FactoryForms480_HtmlAttributeBuilder
			 */
			...
			public function __construct($options, $form)
			{
				...
				$this->html_builder = new Wbcr_FactoryForms480_HtmlAttributeBuilder();
