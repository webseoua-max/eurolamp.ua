<?php
	...
	if( !class_exists('Wbcr_FactoryForms480_FormLayout') ) {

		/**
		 * The base class for all form layouts.
		 */
		abstract class Wbcr_FactoryForms480_FormLayout extends Wbcr_FactoryForms480_Holder {
			...
			public function __construct($options, $form)
			{
				...
				$this->addCssClass('factory-forms-480-' . $this->type);
				$this->addCssClass('factory-forms-480-' . $this->name);
			}
